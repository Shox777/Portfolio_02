...
<html>
  <head>
    ...
    <link rel="stylesheet" href="assets_of_el/css/main.css" />
  </head>
  <body>
    <!-- Header -->
    <header id="header">
    ...
    <footer id="footer">
      <div class="inner">
        ...
        <div class="copyright">
          &copy; Untitled. Design: <a href="#">TEMPLATED</a>.
    ...
    <!-- Scripts -->
    <script src="assets_of_el/js/jquery.min.js"></script>
    <script src="assets_of_el/js/jquery.scrolly.min.js"></script>
    <script src="assets_of_el/js/jquery.scrollex.min.js"></script>
    <script src="assets_of_el/js/skel.min.js"></script>
    <script src="assets_of_el/js/util.js"></script>
    <script src="assets_of_el/js/main.js"></script>
  </body>
</html>
